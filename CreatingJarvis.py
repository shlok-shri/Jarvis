        ...
        if user_dict[name] == [login_id, pass_word]:
            ...
            def run_pappu():
                ...
                if 'play' in command:
                    ...
                    print("The great king of donkey Shlok Shrikhande is my creator, i am his personal donkey ")
                    talk("The great king of donkey Shlok Shrikhande is my creator, i am his personal donkey")
